![Auto Assign](https://github.com/IngesCompany-7742/demo-repository/actions/workflows/auto-assign.yml/badge.svg)

![Proof HTML](https://github.com/IngesCompany-7742/demo-repository/actions/workflows/proof-html.yml/badge.svg)
...
Problemática: 
En el Perú, el control de calidad de fármacos tienen un control no tan eficiente debido a que, además de que tienen que seguir los reglamentos de estándares de la DIGEMID, deben emplear registros, donde en muchos casos optan por procesos manuales, lo que afecta a la eficiencia de los fármacos debido a la velocidad de producción que necesitan.
Segmentos objetivos:
...
Trazabilidad de Extremo a Extremo: Se puede visualizar la información de un fármaco, como su historial completo (máquina en la cual fue fabricada, quien era el operario, parametros fisicos en que se basa y el estante exacto del almacén donde se guardo) 
